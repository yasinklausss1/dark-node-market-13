...
export function TelegramIntegration({
  ...
  const shareToTelegram = (customText?: string) => {
    ...
    const defaultText = productTitle ? `🛍️ Check out this product: ${productTitle}${productPrice ? ` - €${productPrice}` : ''}` : 'Check out this marketplace!';
  ...
  return <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {orderId && <Button variant="outline" size="sm" onClick={notifyOrderUpdate} className="flex items-center gap-2">
