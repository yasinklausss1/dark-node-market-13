...
const TelegramAdBanner = () => {
  return (
    <div className="mb-6">
      ...
      <p className="text-center text-sm md:text-base text-muted-foreground mb-3 max-w-2xl mx-auto">
      ...
      <a
        ...
        className="block relative rounded-xl overflow-hidden hover:opacity-90 transition-opacity"
      >
        <img
          src={telegramBanner}
