  ...
  return <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 rounded-2xl p-8 mb-8">
      ...
      <div className="relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8">
          ...
          <h1 className="text-4xl md:text-6xl font-bold font-cinzel bg-gradient-to-r from-primary via-secondary to-pink bg-clip-text text-transparent mb-6 animate-fade-in delay-200">
            Oracle Market
          </h1>
